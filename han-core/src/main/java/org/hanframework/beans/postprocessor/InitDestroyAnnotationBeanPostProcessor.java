...
public class InitDestroyAnnotationBeanPostProcessor implements DestructionAwareBeanPostProcessor {
    ...
    private Logger logger = LoggerFactory.getLogger(InitDestroyAnnotationBeanPostProcessor.class);
     ...
     * @see org.hanframework.beans.annotation.PostConstruct
     * @see org.hanframework.beans.annotation.PreDestroy
     */
        ...
        do {
            ...
            for (Method method : targetClass.getDeclaredMethods()) {
                ...
                if (this.initAnnotationType != null) {
                    if (method.getDeclaredAnnotation(this.initAnnotationType) != null) {
                ...
                if (this.destroyAnnotationType != null) {
                    if (method.getDeclaredAnnotation(this.destroyAnnotationType) != null) {
    ...
    private static class LifecycleElement {
        ...
        public void invoke(Object target) throws Throwable {
            ReflectionTools.makeAccessible(this.method);
